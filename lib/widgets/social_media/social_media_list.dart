...
import 'package:perfection_som/widgets/social_media/social_media_icon.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SocialMediaIcon(
          buttonText: "Iluminação Futurista",
          buttonColor1: const Color.fromARGB(255, 5, 73, 161),
          buttonColor2: const Color.fromARGB(255, 82, 145, 247),
          iconsColor: Colors.white,
          buttonIcon: FontAwesomeIcons.globe,
          url: "https://iluminacaofuturista.com.br",
        ),
        // SocialMediaIcon(
